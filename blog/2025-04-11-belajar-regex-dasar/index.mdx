...
**Regex** (atau *Regular Expression* ) adalah sebuah pola pencocokan teks yang digunakan untuk mencari, memvalidasi, atau mengganti bagian dari string berdasarkan pola tertentu. Regex sangat berguna dalam pemrograman dan pengolahan data karena memungkinkan kita untuk menemukan teks yang sesuai dengan kriteria tertentu tanpa harus mengetikkan setiap kemungkinan secara manual.
